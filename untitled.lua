...
CreateToggleSettingInGroup(prefGroup, "Anti-AFK", "Prevents idle kicks.", "rbxasset://textures/ui/Settings/Help/Lock.png", 2, SavedData.Settings.AntiAFK, function(val)
